          ...
          <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="mr-2"
                        />
                        <label className="text-sm font-medium text-content-secondary">Delivery Occurred Today</label>
                      </div>
                    </div>

                    {readingForm.delivery_occurred && (
                      <div className="bg-action-primary-light rounded-lg p-4 mb-4 border border-action-primary">
                        <h4 className="font-medium text-action-primary mb-3">Delivery Information</h4>
            ...
            {activeTab === 'deliveries' && (
              <div>
                ...
                {showDeliveryForm && (
                  <form onSubmit={submitDelivery} className="bg-surface-bg rounded-lg p-6 mb-6 border border-surface-border">
                    ...
                    <div className="flex gap-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="px-6 py-2 bg-status-success text-white rounded-md hover:bg-status-success/90 disabled:opacity-50"
                      >
